        ...
        <template>
            ...
            <el-form :inline="true" :model="pageparm" class="user-search" ref="searchForm">
                <el-form-item label="类型：" prop="name">
                    <el-input size="small" v-model="pageparm.name" placeholder="输入仪器用品名称"></el-input>
                </el-form-item>
                <el-form-item label="编号：" prop="number">
                    <el-input size="small" v-model="pageparm.number" placeholder="输入仪器用品编号"></el-input>
                </el-form-item>
                ...
                <el-form-item label="备注：" prop="note">
                    <el-input size="small" v-model="pageparm.note" placeholder="输入仪器用品备注"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <el-table :data="toolData" stripe style="width: 100%" height="800" :cell-style="rowStyle"
                ...
                <el-table-column prop="name" label="类型" width="" align="center"></el-table-column>
                <!-- <el-table-column prop="survey" label="量程" width="" align="center"></el-table-column> -->
                ...
                <el-table-column prop="" label="操作" width="130" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-popover style="min-width: 100px!important;" placement="top-start" title="" width=""
                            trigger="click">
            ...
            <el-dialog :title="title" :visible.sync="editFormVisible" width="40%" :close-on-click-modal="false">
                <el-form label-width="120px" :model="editForm" :rules="rules" ref="editForm">
                    ...
                    <el-form-item label="备注" prop="note">
                        <el-input v-model="editForm.note" auto-complete="off" placeholder="请输入备注"></el-input>
                    </el-form-item>
                </el-form>
...
export default {
    ...
    methods: {
        ...
        getTool() {
            ...
            axios({
                ...
                this.toolData = this.toolData.map(item => {
                    ...
                    // item.nextday = this.getDaysDiff(item.becometime)
                    return item
                })
                this.rowStyle()
                this.loading = false
        ...
        exportExcel() {
            ...
            let openUrl = `${baseURL}/tool/exportsecure?`;
