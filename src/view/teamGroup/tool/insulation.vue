        ...
        <template>
            ...
            <el-form :inline="true" :model="pageparm" class="user-search" ref="searchForm">
                <el-form-item label="名称：" prop="name">
                    <el-input size="small" v-model="pageparm.name" placeholder="输入绝缘用品名称"></el-input>
                </el-form-item>
                <el-form-item label="DC编号：" prop="number">
                    <el-input size="small" v-model="pageparm.number" placeholder="输入绝缘用品DC编号"></el-input>
                </el-form-item>
                <el-form-item label="供电编号：" prop="survey">
                    <el-input size="small" v-model="pageparm.survey" placeholder="输入绝缘用品供电编号"></el-input>
                </el-form-item>
                <el-form-item label="存放位置：" prop="position">
                    <el-input size="small" v-model="pageparm.position" placeholder="输入绝缘用品存放位置"></el-input>
                </el-form-item>
                ...
                <el-form-item label="距离下次送检日期：" prop="nextday">
                    <el-select v-model="pageparm.nextday" placeholder="请选择下次送检天数">
                        <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
                        </el-option>
                    </el-select>
                </el-form-item>
                <el-form-item label="备注：" prop="note">
                    <el-input size="small" v-model="pageparm.note" placeholder="输入绝缘用品备注"></el-input>
                </el-form-item>
                <el-form-item>
            ...
            <el-table :data="toolData" stripe style="width: 100%" height="800" :cell-style="rowStyle"
                ...
                <el-table-column prop="number" label="DC编号" width="" align="center">
                    <template slot-scope="scope">
                        {{ scope.row.number == 'null' ? '' : scope.row.number }}
                    </template>
                </el-table-column>
                <el-table-column prop="survey" label="供电编号" width="" align="center">
                    <template slot-scope="scope">
                ...
                <el-table-column prop="" label="操作" width="130" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-popover placement="top-start" title="" width="" trigger="click">
                            <el-button type="text" icon="" circle @click="changeType(scope.row.id, 1)">
                                <i class="el-icon-top"></i>计量
                            </el-button>
                            <el-button type="text" icon="" circle @click="changeType(scope.row.id, 3)">
                                <i class="el-icon-top"></i>仪器
                            </el-button>
                            <el-button type="text" circle slot="reference"><i style="padding: 9px;"
            ...
            <el-dialog :title="title" :visible.sync="editFormVisible" width="40%" :close-on-click-modal="false">
                <el-form label-width="120px" :model="editForm" :rules="rules" ref="editForm">
                    ...
                    <el-form-item label="DC编号" prop="number">
                        <el-input v-model="editForm.number" auto-complete="off" placeholder="请输入DC编号"></el-input>
                    </el-form-item>
                    <el-form-item label="供电编号" prop="survey">
                        <el-input v-model="editForm.survey" auto-complete="off" placeholder="请输入供电编号"></el-input>
                    </el-form-item>
                    <el-form-item label="存放位置" prop="position">
...
export default {
    ...
    methods: {
        ...
        exportExcel() {
            ...
            let openUrl = `${baseURL}/tool/exportinsulation?`;
