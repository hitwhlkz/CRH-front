    ...
    <div>
        ...
        <el-form :inline="true" :model="pageparm" class="user-search" ref="searchForm">
            ...
            <el-form-item label="复核" prop="review">
                <el-select v-model="pageparm.review" placeholder="请选择" @change="changeInput($event)">
            ...
            <el-form-item label="处理班组" prop="teamsGroups">
                <el-select v-model="pageparm.teamsGroups" placeholder="请选择处理班组" @change="changeUpdate">
