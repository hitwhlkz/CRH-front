  ...
  <div>
    ...
    <el-dialog :title="title" :visible.sync="editFormVisible" width="50%" @click="closeDialog('editForm')">
      <el-form label-width="120px" :model="editForm" ref="editForm">
        <el-form-item label="文号" prop="motorDocumentNumber">
          <el-input v-model="editForm.motorDocumentNumber" :min="1" label="" placeholder="请输入文号"></el-input>
        </el-form-item>
        <el-form-item label="项目名称" prop="entryName">
        ...
        <el-form-item label="总量" prop="total">
          <el-input-number :min="0" :max="10000" v-model="editForm.total" auto-complete="off"
            placeholder="请输入总量"></el-input-number>
        </el-form-item>
        <el-form-item label="已完成" prop="complTotal">
          <el-input-number :min="0" :max="10000" v-model="editForm.complTotal" auto-complete="off"
            placeholder="请输入已完成"></el-input-number>
        </el-form-item>
        <el-form-item label="未完成" prop="incomplTotal">
          <el-input-number :min="0" :max="10000" v-model="editForm.incomplTotal" auto-complete="off"
            placeholder="请输入未完成"></el-input-number>
        </el-form-item>
...
import { squareCarNumberList } from '../../../common/squareCarnumbers'
...
export default {
  ...
  methods: {
    ...
    exportSourceFinalExcel() {
      let openUrl = `${baseURL}/source/exportsourcefinaltechnologysquare?`;
    ...
    updateNumber(sid) {
      axios({
        ...
        delete this.editForm.total
        delete this.editForm.complTotal
        delete this.editForm.incompl
